//
//The dependencies which are required
...
// User choose the department list and then teh employees pop up
...
function promptInsert(roleChoices) {
  inquirer
    ...
    .then(function (answer) {
      ...
      // when you are finished prompting
      // this will insert a new item into the db with that new info
...
// Make a employee array to delete it
